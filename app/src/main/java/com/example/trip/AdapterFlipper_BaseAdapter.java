...
public class AdapterFlipper_BaseAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        picture = view.findViewById(R.id.imageView3);
        name = view.findViewById(R.id.textView14);
        state = view.findViewById(R.id.textView15);
        favourite = view.findViewById(R.id.imageView20);
        ...
        favourite.setImageResource(R.drawable.baseline_favorite_24); //the same image would be in all the view of the flipper
